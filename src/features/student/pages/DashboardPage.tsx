    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl border border-white/10 bg-white/2 p-5">
          ...
          <p className="mt-1 text-xs text-gray-600">Enrolled courses</p>
        </div>
        ...
        <div className="rounded-xl border border-white/10 bg-white/2 p-5">
          ...
          <p className="mt-1 text-xs text-gray-600">Pending assignments</p>
        </div>
        ...
        <div className="rounded-xl border border-white/10 bg-white/2 p-5">
          ...
          <p className="mt-1 text-xs text-gray-600">Overall attendance</p>
        </div>
        ...
        <div className="rounded-xl border border-white/10 bg-white/2 p-5">
          ...
          <p className="mt-1 text-xs text-gray-600">Current performance</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="flex items-center justify-between rounded-lg border border-white/5 bg-white/2 p-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-600">12 lessons</p>
              </div>
            ...
            <div className="flex items-center justify-between rounded-lg border border-white/5 bg-white/2 p-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-600">18 lessons</p>
              </div>
            ...
            <div className="flex items-center justify-between rounded-lg border border-white/5 bg-white/2 p-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-600">10 lessons</p>
              </div>
        ...
        <section className="rounded-xl border border-white/10 bg-white/2 p-6">
          ...
          <p className="mt-1 text-xs text-gray-500">Your upcoming deadlines</p>
          ...
          <div className="mt-6 space-y-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-600">Due tomorrow</p>
            </div>

            {/* Deadline 2 */}
            <div>
              <p className="text-sm font-medium text-gray-300">React Project</p>

              <p className="mt-1 text-xs text-gray-600">Due September 4</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-600">Due September 7</p>
            </div>
          </div>
        </section>
      </div>
