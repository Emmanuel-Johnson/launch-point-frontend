          ...
          <div className="relative z-10 mx-auto w-full max-w-sm">
            ...
            >
              ...
              <div className="relative w-full">
                {/* Your custom-looking button */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/3 py-3.5 text-sm font-medium text-white">
