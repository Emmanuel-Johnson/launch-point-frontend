      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-7 max-w-2xl text-lg leading-8 text-zinc-400 sm:text-xl">
            Master practical skills through structured courses, expert guidance,
            and hands-on learning designed to help you achieve your goals.
          </p>
    ...
    sm:w-auto"
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-3 divide-x divide-white/10 border-y border-white/10 py-7">
            <div className="px-4">
              ...
              <p className="mt-1 text-xs text-zinc-500 sm:text-sm">Learners</p>
            </div>
