  ...
  return (
    <section className="relative overflow-hidden border-t border-white/10 bg-[#0F0F12] py-24">
      ...
      <div className="relative mx-auto max-w-5xl px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/3 px-6 py-16 text-center shadow-2xl sm:px-12 lg:px-20 lg:py-20">
          {/* Small Label */}
    ...
    transition-all duration-700 ease-out
    hover:scale-[1.04] hover:bg-white/8 hover:border-white/20
    sm:w-auto"
            >
              Create Free Account
            </Link>
