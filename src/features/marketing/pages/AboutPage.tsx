  ...
  const values = [
    {
      ...
      title: "Practical",
      description:
        "Focus on knowledge and skills that can be applied to real problems and real opportunities.",
    },
    {
      number: "02",
      title: "Focused",
      description:
        "Clear learning paths that help you spend less time searching and more time actually learning.",
    },
    {
      number: "03",
      title: "Growth",
      description:
        "Keep improving your skills and build the confidence to take the next step.",
    },
  ];
          ...
          <div>
            ...
            <Reveal delay={450}>
              <p className="mt-6 text-base leading-8 text-zinc-400">
                ...
                skills, or preparing for your next career opportunity, our goal
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          <div className="mt-14 grid gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 md:grid-cols-3">
            {values.map((value, index) => (
              <Reveal key={value.number} delay={300 + index * 150}>
                <div className="group h-full bg-[#09090B] p-8 transition-all duration-700 ease-out hover:-translate-y-1 hover:bg-[#111113] hover:shadow-[0_20px_50px_rgba(79,70,229,0.08)]">
